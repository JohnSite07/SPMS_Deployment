...
| M4 | [SecureVault_Milestone4_Deployment.docx](SecureVault_Milestone4_Deployment.docx) | 2026-06-25 | System design: GCP deployment architecture, Terraform, CI/CD, cost analysis. |
...
- **M4** is the deployment specification → reflected in [architecture/](../architecture/), [deployment/](../deployment/), and the root [CLAUDE.md](../../CLAUDE.md).
